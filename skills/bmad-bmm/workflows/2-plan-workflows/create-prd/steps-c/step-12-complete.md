...
PRD complete. Read fully and follow: `{project-root}/skills/bmad-init/core/tasks/help.md`
...
Append `step-12-complete` to the `stepsCompleted` array in this document's frontmatter.
